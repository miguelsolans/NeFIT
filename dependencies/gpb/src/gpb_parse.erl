...
-file("src/gpb_parse.erl", 4672).
-compile({inline,yeccpars2_186_/1}).
-file("src/gpb_parse.yrl", 334).
...
-file("src/gpb_parse.erl", 4756).
-compile({inline,yeccpars2_204_/1}).
-file("src/gpb_parse.yrl", 340).
...
-file("src/gpb_parse.erl", 4992).
-compile({inline,yeccpars2_251_/1}).
-file("src/gpb_parse.yrl", 281).
